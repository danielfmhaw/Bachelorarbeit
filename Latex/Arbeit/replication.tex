...
Die Schreibgeschwindigkeit ist in beim Fall ohne und mit Replikation auf einem ähnlichen Niveau, wobei die Version mit Master-Replica etwa 10\% langsamer ist.
...
Als Nächstes betrachten wir ein praxisnahes Szenario:
...
Betrachten wir das Ergebnis aus~\ref{fig:replication-multiple-select-threads}, werden die Vorteile der Replikation deutlich.
