...
In unserem Beispiel verwenden wir ohnehin nur eine MySQL-Version (siehe \ref{sec:durchfuhrung}).
...
Um die eigentliche Replikation aber erst zu starten, muss man den folgenden Befehl ausführen:
